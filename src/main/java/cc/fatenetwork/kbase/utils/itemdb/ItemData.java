package cc.fatenetwork.kbase.utils.itemdb;
...
public class ItemData implements ConfigurationSerializable {
	...
	public ItemData(final Map<String, Object> map){
		...
		if(!(object instanceof String)){
			throw new AssertionError("Incorrectly configurized");
		}
	...
	public static ItemData fromItemName(final String string){
		final ItemStack stack = Base.getPlugin().getItemDb().getItem(string);
	...
	public String getItemName(){
		return Base.getPlugin().getItemDb().getName(new ItemStack(this.material, 1, this.itemData));
	}
